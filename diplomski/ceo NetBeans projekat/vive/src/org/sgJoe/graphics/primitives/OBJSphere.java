...
/**
 * This class is used to help identify a sphere object in the scenegraph.
 * Spheres in sgJoe are created by loading an OBJ file. 
 *
 * @author   $ Author: Aleksandar Babic         $
 * @version  $ Revision:            0.1         $
 * @date     $ Date:  December 8, 2005 5:55 PM  $
 */
public class OBJSphere extends BranchGroup implements SceneGraphIO {
    
    private static Logger logger = Logger.getLogger(OBJSphere.class);
    ...
    public Node cloneNode(boolean forceDuplicate) {
        ...
        objSphere.duplicateNode(this, forceDuplicate);
        return objSphere;
    }    
}
