...
/*
 * Descritpion for sgJViewer.java
 *
 *
 * @author   $ Author: Aleksandar Babic  $
 * @version  $ Revision:             0.1 $
 * @date     $ Date: February 3, 2006  4:10 PM  $
 */
 ...
 * @see ViewerAvatar
 */
public class SGViewer {
    
    private static Logger logger = Logger.getLogger(SGViewer.class);
    ...
    private        SGViewingPlatform           viewingPlatform     = null;
    ...
    public static SGViewer getViewer(View view) {
	SGViewer viewer = null;
	synchronized (viewerMap) {
	    //System.out.println("Viewer.getViewer viewerMap's size is " + viewerMap.size());
	    viewer =  (SGViewer) (viewerMap.get(view));
	}
	return viewer;
    }
     ...
     */
    // To support a back door for DVR support.
    public static SGViewer removeViewerMapEntry(View view) {
	SGViewer viewer = null;
	synchronized (viewerMap) {

	    viewer =  (SGViewer) (viewerMap.remove(view));
	}
     ...
     * @since Java3D 1.1
     */
    public SGViewer(Canvas3D userCanvas) {
     ...
     * @since Java3D 1.3
     */
    public SGViewer(Canvas3D[] userCanvases) {
     ...
     * @since Java3D 1.3
     */
    public SGViewer(Canvas3D[] userCanvases, PhysicalBody userBody,
	...
	synchronized (viewerMap) {
	    SGViewer.viewerMap.put(view, this);
	}
     ...
     */
    public SGViewer(URL userConfig) {
        // Call main constructor.
     ...
     * @deprecated create a ConfiguredUniverse to use a configuration file
     */
    public SGViewer(Canvas3D userCanvas, URL userConfig) {
        ...
        if (userCanvas == null) {
	    GraphicsConfiguration config =
		SGUniverse.getPreferredConfiguration();
     ...
     */
//    sgJViewer(ConfigScreen[] cs, ConfigView cv, boolean setVisible) {
//
...
//	// Add it to the Viewer's HashMap.
//	synchronized (viewerMap) {
//	    sgJViewer.viewerMap.put(view, this);
//	}
//
...
//    
     ...
     */
    public void setViewingPlatform(SGViewingPlatform platform) {
