...
/*
 * Description for NavigateStudyRollBehavior.java
 *
 *
...
public class NavigateStudyPaneBehavior extends SGMouseBehaviour {
    
    private static Logger logger = Logger.getLogger(NavigateStudyPaneBehavior.class);
     ...
     */
    public NavigateStudyPaneBehavior(Component c) {
        super(c, 0);
        myID = ++counter;
        ...
        if (((buttonPress)&&((flags & MANUAL_WAKEUP) == 0)) ||
            ...
            if ((id == MouseEvent.MOUSE_DRAGGED) && !evt.isMetaDown() && !evt.isAltDown()) {
                ...
                if ((!reset) && ((Math.abs(dy) < 50) && (Math.abs(dx) < 50))) {
                    ...
                    this.calcViewPosition(true, true);
    ...
    public void copyStateFrom (SGMouseBehaviour fromBhv) {
        ...
        NavigateStudyPaneBehavior nspb = (NavigateStudyPaneBehavior) fromBhv;
