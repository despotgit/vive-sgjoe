...
/*
 * Descritpion for PointLightVToolPlugin.java
 *
 *
 * @author   $ Author: Aleksandar Babic  $
 * @version  $ Revision:             0.1 $
 * @date     $ Date: June 4, 2006  5:56 PM  $
 */


public class PointLightVToolPlugin extends LightVToolPlugin {
    
    private static Logger logger = Logger.getLogger(PointLightVToolPlugin.class);
   
    public PointLightVToolPlugin(VirTool virToolRef) {
        super(virToolRef);
    }
...
//                observer.update(operatorsForm);                  
            ...
            Light light = vTool.getLight();
            PointLightVToolForm ptForm = (PointLightVToolForm) toolForm;
