...
/*
 * Descritpion for sgJButtonGroup.java
 *
 *
 * @author   $ Author: Aleksandar Babic             $
 * @version  $ Revision:             0.1            $
 * @date     $ Date: February 23, 2006  1:55 PM     $
 */

public class SGButtonGroup extends ButtonGroup {
    
    private static Logger logger = Logger.getLogger(SGButtonGroup.class);
     ...
     */
    public SGButtonGroup(AbstractButton[] buttons) {
        add(buttons);
    }
